...
const ObjectsDataTable = ({ items, fields, onEditRow, onRowDelete, onRowClick, searchDialog, setSearchDialog,   showUpload, setShowUpload,
  ...
  const handleHideDialog = () => {
    ...
    return (
      ...
      {selectedItems.length > 0 ? (
        ...
        <Dialog header="Upload Objects Data" visible={showUpload} onHide={() => setShowUpload(false)}>
        <UploadService 
          user={user} 
          serviceName="objects"            
          onUploadComplete={() => {
      ...
      <Dialog header="Search Objects" visible={searchDialog} onHide={() => setSearchDialog(false)}>
      Search
    </Dialog>
    <Dialog
        header="Filter Users"
...
export default ObjectsDataTable;